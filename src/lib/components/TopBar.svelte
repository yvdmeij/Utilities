...
<header class="topbar">
  ...
  <div class="topbar-side topbar-side-end">
    <button class="theme-toggle" onclick={() => onToggleDark?.()} aria-label={dark ? 'Switch to light mode' : 'Switch to dark mode'}>
      {#if dark}
